        ...
        <div class="vip-right">
            ...
            <div align="center">
                <label class="butt" id="butt">
                    <input type="button" class="member_mod_buttom" onclick="location.href='${pageContext.request.contextPath}/pages/verifyApply.jsp'" value="立即申请"/>
                </label>
            </div>
            </c:if>
            <c:if test="${userAuth!=null&&userAuth.authStatus==2}">
            <br>
            <br>
            <br>
            <br>
            ...
            <c:if test="${userAuth!=null&&userAuth.authStatus==0}">
            <br>
            <br>
            <br>
            <br>
            ...
            <div align="center">
                <label class="butt" id="butt3">
                    <input type="button" class="member_mod_buttom" onclick="location.href='${pageContext.request.contextPath}/pages/verifyApply.jsp'"
                           value="立即申请"/>
                </label>
            </div>
            </c:if>
            <c:if test="${userAuth!=null&&userAuth.authStatus==1}">
            <br>
            <br>
            <br>
            <br>
