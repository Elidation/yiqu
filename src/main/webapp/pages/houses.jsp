    ...
    <div class="width1190">
        <div class="pro-left">
            ...
            <div class="pull-right">
                <ul class="pagination">
                    <li>
                        <a href="${pageContext.request.contextPath}/house/findAllHouseInfo.do?houseType=${pageInfo.list.get(0).houseType}&page=${pageInfo.navigateFirstPage}&size=5"
                           aria-label="Previous">首页</a></li>
                    <li>
                        <a href="${pageContext.request.contextPath}/house/findAllHouseInfo.do?houseType=${pageInfo.list.get(0).houseType}&page=${pageInfo.prePage}&size=5">上一页</a>
                    </li>
                    <c:forEach begin="1"  end="${pageInfo.pages}" var="page">
                        <li>
                            <a href="${pageContext.request.contextPath}/house/findAllHouseInfo.do?houseType=${pageInfo.list.get(0).houseType}&page=${page}&size=5">${page}</a>
                        </li>
                    </c:forEach>
                    <li>
                        <a href="${pageContext.request.contextPath}/house/findAllHouseInfo.do?houseType=${pageInfo.list.get(0).houseType}&page=${pageInfo.nextPage}&size=5">下一页</a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/house/findAllHouseInfo.do?houseType=${pageInfo.list.get(0).houseType}&page=${pageInfo.navigateLastPage}&size=5"
        ...
        <div class="pro-right">
            ...
            <div class="right-pro">
                <c:forEach var="randomHouse" items="${remmondHouse}">
                    <dl>
                        <dt>
                            <a href="#"><img
